...
data_fim = '20260101'
url_base = 'https://api.beteltecnologia.com/pagamentos?data_inicio=' + data_inicio + '&data_fim=' + data_fim
url_base_for = 'https://api.beteltecnologia.com/pagamentos?data_inicio=' + data_inicio + '&data_fim=' + data_fim + '&pagina='
...
# Save to JSON
try:
    with open("gestao_click_api/pagamentos/pagamentos.json", "w", encoding="utf-8") as json_file:
...
# try:
#     with open("pagamentos.csv", "w", newline="", encoding="utf-8") as csv_file:
#         if result:
